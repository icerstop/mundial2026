  ...
  const sections = [
    {
      title: '🎯 Atak',
      items: [
        { label: 'Strzały łącznie', value: totalShots },
        { label: 'Strzały celne', value: totalOnTarget },
        ...
        { label: 'Gole łącznie', value: DATA.stats.totalGoals },
    ...
    },
    {
      ...
      items: [
        { label: 'Podania łącznie', value: totalPasses.toLocaleString('pl') },
        { label: 'Śr. podań / mecz', value: n > 0 ? Math.round(totalPasses / n).toLocaleString('pl') : '—' },
        { label: 'Kornery łącznie', value: totalCorners },
    ...
    },
    {
      ...
      items: [
        { label: 'Faule łącznie', value: totalFouls },
        { label: 'Śr. fauli / mecz', value: n > 0 ? (totalFouls / n).toFixed(1) : '—' },
        { label: 'Spalone łącznie', value: totalOffsides },
        { label: 'Łączna frekwencja', value: totalAttendance.toLocaleString('pl') },
    ...
    <div class="ts-card animate-in">
      ...
      ${s.items.map(item => `
        <div class="ts-item">
          ...
          <span class="ts-item__value">${item.value}</span>
        </div>
      `).join('')}
    </div>
  `).join('');
